...
(function () {
  ...
  const LOCAL_VIDEO_LOOPS = [
    '/pixo-clone/videos/seedance2/gallery-product-ad.mp4',
    '/pixo-clone/videos/seedance2/gallery-social-media.mp4',
    '/pixo-clone/videos/seedance2/gallery-short-film.mp4',
    '/pixo-clone/videos/feature-video-series.mp4',
    '/pixo-clone/videos/feature-ai-agents.mp4',
    '/pixo-clone/videos/feature-team-collab.mp4'
  ];
  ...
  const updateModelTriggerDisplay = (triggerBtn) => {
    ...
    if (currentPromptMode === 'model') {
      const logoUrl = {
        'Seedance 2.0 Fast': '/pixo-clone/images/company/bytedance.svg',
        'Seedance 2.5 Cinema': '/pixo-clone/images/company/bytedance.svg',
        'Google Veo': '/pixo-clone/images/company/google.svg',
        'Kling Cinema': '/pixo-clone/images/company/kuaishou.svg',
        'Hailuo Rapid': '/pixo-clone/images/company/minimax.svg',
        'Sora 2': '/pixo-clone/images/company/openai.svg',
        'WAN 2.6': '/pixo-clone/images/company/qwen.svg'
      }[activeModelSelected] || '/pixo-clone/images/company/bytedance.svg';
      ...
      <div style="max-height: 320px; overflow-y: auto;">
        <div>
          ...
          <div style="display:flex; align-items:center; gap:8px; padding: 8px 12px; opacity: 0.5;">
            <img alt="" width="20" height="20" src="/pixo-clone/images/company/bytedance.svg" style="width:20px; height:20px; object-fit: contain;">
        ...
        <div>
          ...
          ${[
            { name: 'ByteDance', model: 'Seedance 2.0 Fast', logo: '/pixo-clone/images/company/bytedance.svg' },
            { name: 'Google', model: 'Google Veo', logo: '/pixo-clone/images/company/google.svg' },
            { name: 'Kuaishou', model: 'Kling Cinema', logo: '/pixo-clone/images/company/kuaishou.svg' },
            { name: 'MiniMax', model: 'Hailuo Rapid', logo: '/pixo-clone/images/company/minimax.svg' },
            { name: 'OpenAI', model: 'Sora 2', logo: '/pixo-clone/images/company/openai.svg' },
            { name: 'WAN', model: 'WAN 2.6', logo: '/pixo-clone/images/company/qwen.svg' }
          ].map(p => {
        ...
        <div>
          ...
          ${[
            { name: 'Grok Imagine Video', logo: '/pixo-clone/images/company/xai.svg' },
            { name: 'LTX 2.3 Pro', logo: '/pixo-clone/images/company/ltx.svg' },
  ...
  const openCreateProjectModal = () => {
    ...
    submitBtn.addEventListener('click', (e) => {
      ...
      if (window.location.pathname.includes('/projects')) {
        ...
        window.location.href = "/pixo-clone/org-9cbd03fa/projects.html";
      }
    });
  };
